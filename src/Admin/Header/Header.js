  ...
  return (
    <>
      <div className="headeradmin">
        ...
        <Link className="pages" to="/User">Users</Link>
        <Link className="pages" to="/Message">Messages</Link>
        {/* <div className="popup"> */}
        <Popover placement="bottomRight" className="popup" title={text} content={content}  trigger="click">
